<?php
/* Smarty version 4.3.4, created on 2024-03-11 18:22:10
  from '/Applications/MAMP/htdocs/mvc_app/Views/contact/update.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65eecd427dc2b3_58629315',
...
function content_65eecd427dc2b3_58629315 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
  <head>
...
">
              <div class="form-item container">
                ...
                <input id="checkName" class="blank col-11" type="text" name="name" value=<?php echo $_smarty_tpl->tpl_vars['myContact']->value['name'];?>
>
              ...
              <div class="form-item container">
                ...
                <input id="checkKana" class="blank col-11" type="text" name="kana" value=<?php echo $_smarty_tpl->tpl_vars['myContact']->value['kana'];?>
>
                <p class="blankAttention" style="color: red;"></p>
              ...
              <div class="form-item container">
                ...
                <input id="checkTel" class="col-11" type="text" name="tel" value=<?php echo $_smarty_tpl->tpl_vars['myContact']->value['tel'];?>
>
              ...
              <div class="form-item container">
                ...
                <input id="checkEmail" class="blank col-11" type="text" name="email" value=<?php echo $_smarty_tpl->tpl_vars['myContact']->value['email'];?>
>
                <p class="blankAttention" style="color: red;"></p>
              ...
              <div class="form-item container">
                ...
                <textarea id="checkBody" class="blank col-11" name="body"><?php echo $_smarty_tpl->tpl_vars['myContact']->value['body'];?>
</textarea>
                <p class="blankAttention" style="color: red;"></p>
